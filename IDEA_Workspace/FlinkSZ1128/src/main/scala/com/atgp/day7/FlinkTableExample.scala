...
object FlinkTableExample {
    def main(args: Array[String]): Unit = {
        ...
        tableEnv
                .connect(new FileSystem().path("F:\\workspace\\IDEA_Workspace\\FlinkSZ1128\\src\\main\\resources\\sensor.txt"))
        ...
        val resultSqlTable: Table = tableEnv
                .sqlQuery("select id, temperature from inputTable where id ='sendor1'")
